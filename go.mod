...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20210331235223-7ce8ff441ae4 // indirect
...
replace github.com/dgrijalva/jwt-go => github.com/golang-jwt/jwt/v4 v4.4.1 // indirect
